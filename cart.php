...
<nav id="header-menu">
    <ul>
        ...
        <li><a href="http://localhost/web/shuhu/shopping.php"">商品<i class="fas fa-image"></i></a></li>
        <li><a href="login_form.php">ユーザー<i class="fas fa-user"></i></a></li>
            ...
            <div class="wrapper last-wrapper" align="center">
                ...
                <div class="wrapper-title">
                    ...
                    <div class="cartlist">
                        ...
                        <div class="cart-btn">
                            <button type="button"  class="btn-sm btn-blue" onclick="location.href='http://localhost/web/shuhu/login_form.php'">ログイン</button>
                        </div>
                    </div>
                </div>
            </div>
