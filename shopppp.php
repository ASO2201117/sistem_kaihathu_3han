...
<figure><a href="index.html"><img src="images/iron.jpg" alt="アイロン"></a></figure>
<div class="text">
<h4>アイロン</h4>
<p>¥1000   アイロンです</p>
<form action="shopping.php" method="POST" class="item-form">
...
<div class="list-square blur">
<figure><a href="index.html"><img src="images/shohin1.jpg" alt="洗濯機"></a></figure>
<div class="text">
<h4>洗濯機</h4>
<p>¥2000   洗濯機です</p>
<form action="shopping.php" method="POST" class="item-form">
...
<div class="list-square blur">
<figure><a href="index.html"><img src="images/renzi.jpg" alt="電子レンジ"></a></figure>
<div class="text">
<h4>電子レンジ</h4>
<p>¥2000   電子レンジです</p>
<form action="shopping.php" method="POST" class="item-form">
...
<div class="list-square blur">
<figure><a href="index.html"><img src="images/potto.jpg" alt="電気ポット"></a></figure>
<div class="text">
<h4>電気ポット</h4>
<p>¥1500   電気ポットです</p>
<form action="shopping.php" method="POST" class="item-form">
...
<div class="list-square blur">
<figure><a href="index.html"><img src="images/shohin2.jpg" alt="炊飯器"></a></figure>
<div class="text">
<h4>炊飯器</h4>
<p>¥3000   炊飯器です</p>
<form action="shopping.php" method="POST" class="item-form">
...
<div class="list-square blur">
<figure><a href="index.html"><img src="images/shohin3.jpg" alt="掃除機"></a></figure>
<div class="text">
<h4>掃除機</h4>
<p>¥5000   掃除機です</p>
<form action="shopping.php" method="POST" class="item-form">
...
<div class="list-square blur">
<figure><a href="index.html"><img src="images/shohin9.jpg" alt="ミキサー"></a></figure>
<div class="text">
<h4>ミキサー</h4>
<p>¥2000   ミキサーです</p>
<form action="shopping.php" method="POST" class="item-form">
...
<div class="list-square blur">
<figure><a href="index.html"><img src="images/shohin8.jpg" alt="圧力鍋"></a></figure>
<div class="text">
<h4>圧力鍋</h4>
<p>¥4000   圧力鍋です</p>
<form action="shopping.php" method="POST" class="item-form">
...
<div id="footermenu">
    <ul>
        ...
        <li><a href="shopping.html">商品</a></li>
        <li><a href="shopping.html">ユーザー</a></li>
        <li><a href="event.html">イベント</a></li>
        <li><a href="event.html">カート</a></li>
...
<nav>
    ...
    <li><a href="shopping.html">ユーザー</a></li>
    <li><a href="event.html">イベント</a></li>
    <li><a href="access.html">カート</a></li>
    </ul>
</nav>
